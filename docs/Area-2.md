...
## 镜之房间
{% include room.html name="镜之房间" ja="鏡の部屋" en="Mirror Room" ghost="镜之托基 x 3" boo="嘘嘘山" item="镜火" %}
...
## 洗衣房
{% include room.html name="洗衣房" ja="洗濯部屋" en="Laundry Room" ghost="马普 x 2，托基（白），托基（红）" boo="嘘嘘寺" %}
...
## 休息室
{% include room.html name="休息室" ja="休憩室" en="Butler's Room" ghost="蓝鼠" portrait="申管" boo="嘘嘘冰" %}
...
## 隐藏房间
{% include room.html name="隐藏房间" ja="隠し部屋" en="Hidden Room" ghost="冰马普 x 4，巴蒂（黄）" boo="嘘嘘艺" item="镜" %}
...
## 音乐室
{% include room.html name="音乐室" ja="音楽室" en="Conservatory" portrait="刚秦" boo="嘘嘘林" %}

* 调查所有乐器使它们全部发出响声，出现绘画鬼怪：刚秦。
...
## 餐厅
{% include room.html name="餐厅" ja="食堂" en="Dining Room" ghost="侍者托基，富亚普，金鼠" portrait="超范" boo="嘘嘘陆" item="火" %}
...
## 厨房
{% include room.html name="厨房" ja="台所" en="Kitchen" ghost="冰马普，富亚普，金鼠" boo="嘘嘘武" item="水冰" %}
